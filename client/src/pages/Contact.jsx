          ...
          <div className='flex-1'>
            ...
            <div className="flex flex-col gap-3">
              <div className="flex flex-col">
                ...
                <p className='flexStart gap-x-2'><FaLocationDot /> 80/68 Duong Quang Ham, Ward 5, Go Vap District, City. Ho Chi Minh City (Go Vap District side) and 69/68 Dang Thuy Tram, Ward 13, Binh Thanh District, City. Ho Chi Minh (Binh Thanh District side)</p>
              </div>
              <div className="flex flex-col">
                <h5 className="h5 capitalize mr-4">email:</h5>
                <p className='flexStart gap-x-2'><FaEnvelope /> God@gmail.com</p>
              </div>
              <div className="flex flex-col">
                <h5 className="h5 capitalize mr-4">phone:</h5>
                <p className='flexStart gap-x-2'><FaPhone /> 0123456789</p>
              </div>
              <div className="flex flex-col">
                <h5 className="h5 capitalize mr-4">
                  Support:
